...
if [ ! -f ../../azure/test/personal/sourceme.sh ]; then
  ...
  az ad sp create-for-rbac --role="Contributor" --scopes="/subscriptions/${subscription}" -n"http://terragrunt-${subscription}" -o json > sp.json
